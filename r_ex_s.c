/*
** File: C:\Documents and Settings\emeliehe\My Documents\skola\EmbeddedII\lab7vh\r_ex_s.c
...
** bsIdNameTable
==========================================================*/
bsIdNameElement_t const bsIdNameTable[9] ={
  /* 0 */ {"bsAttr",6},
  /* 1 */ {"bsLogAttr",9},
  /* 2 */ {"greenAttr",9},
  /* 3 */ {"blueAttr",8},
...
extern bsLogIdArray_t bsLogIdArray[9];
char_t const * const bsLabelDate = "2012-05-03T16:05:41";
char_t const * const bsLabelCoder = "Generic:v3.9.1 (Build 77) 2011a";
char_t const * const bsLabelIdentifier = "5d77f7a7-3119-41d5-b3b7-f305f850c6e5";
bsObject_t const * const bsIdTable[9] ={
  ...
  /* 7 */ (bsObject_t const *)&blinky0,
  /* 8 */ (bsObject_t const *)&redScheduleStart
};
